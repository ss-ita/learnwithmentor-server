...
insert into UserTasks(User_Id,PlanTask_Id,Mentor_Id,State,End_Date,Result) SELECT Users.Id, PlanTasks.Id, Groups.Mentor_Id, 'p','2018-08-10','link msdn' FROM Users, PlanTasks, Groups WHERE Groups.Name = 'lv.net319' AND Users.Email = 'roman.p@gmail.com' AND PlanTasks.Task_Id = (SELECT Tasks.Id FROM Tasks WHERE Tasks.Name = 'OOP');
insert into UserTasks(User_Id,PlanTask_Id,Mentor_Id,State,End_Date,Result) SELECT Users.Id, PlanTasks.Id, Groups.Mentor_Id, 'p','2018-09-08','link stackoverflow' FROM Users, PlanTasks, Groups WHERE Groups.Name = 'lv.net319' AND Users.Email = 'riman@gmail.com' AND PlanTasks.Task_Id =(SELECT Tasks.Id FROM Tasks WHERE Tasks.Name = 'Collections');
insert into UserTasks(User_Id,PlanTask_Id,Mentor_Id,State,End_Date,Result) SELECT Users.Id, PlanTasks.Id, Groups.Mentor_Id, 'p','2018-10-09','link github' FROM Users, PlanTasks, Groups WHERE Groups.Name = 'lv.net319' AND Users.Email = 'andrew.l@gmail.com' AND PlanTasks.Task_Id = (SELECT Tasks.Id FROM Tasks WHERE Tasks.Name = 'Exceptions');
insert into UserTasks(User_Id,PlanTask_Id,Mentor_Id,State,End_Date,Result, Propose_End_Date) SELECT Users.Id, PlanTasks.Id, Groups.Mentor_Id, 'p','2018-08-03','link google.com', '2018-08-13T14:25:10' FROM Users, PlanTasks, Groups WHERE Groups.Name = 'lv.net319' AND Users.Email = 'andrew.l@gmail.com' AND PlanTasks.Task_Id = (SELECT Tasks.Id FROM Tasks WHERE Tasks.Name = 'Exceptions');
